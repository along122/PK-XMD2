...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pk~blQnxSpI#OKB5Pj52_fyVXaNXoBG8spo8RGJrdnGdv0Q7A2cP-mo",
...
STICKER_NAME: process.env.STICKER_NAME || "AKA",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "916009595805",
...
DEV: process.env.DEV || "916009595805",
